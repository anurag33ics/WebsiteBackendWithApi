<?php
/**
 *    SimpleXLSXR php class v0.8.17
 *    MS Excel 2007 workbooks reader
 *
 * Copyright (c) 2012 - 2020 SimpleXLSXR
 *
 * @category   SimpleXLSXR
 * @package    SimpleXLSXR
 * @copyright  Copyright (c) 2012 - 2020 SimpleXLSXR (https://github.com/shuchkin/SimpleXLSXR/)
 * @license    MIT
 * @version    0.8.17
 */
 ...
 *
 * Example 1:
 * if ( $xlsx = SimpleXLSXR::parse('book.xlsx') ) {
 *   print_r( $xlsx->rows() );
 * } else {
 *   echo SimpleXLSXR::parseError();
 * }
 *
 ...
 *
 * Example 3: rowsEx
 * $xlsx = SimpleXLSXR::parse('book.xlsx');
 * print_r( $xlsx->rowsEx() );
 *
 ...
 *
 * Example 8: read data
 * if ( $xlsx = SimpleXLSXR::parseData( file_get_contents('http://www.example.com/example.xlsx') ) ) {
 ...
 *
 * Example 9: old style
 * $xlsx = new SimpleXLSXR('book.xlsx');
 * if ( $xlsx->success() ) {
 *   print_r( $xlsx->rows() );
 * } else {
